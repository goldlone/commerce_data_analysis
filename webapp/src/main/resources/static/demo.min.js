var $jscomp = { scope: {}, findInternal: function(a, b, c) { a instanceof String && (a = String(a)); for (var d = a.length, e = 0; e < d; e++) { var f = a[e]; if (b.call(c, f, e, a)) return { i: e, v: f } } return { i: -1, v: void 0 } } };
...
$jscomp.getGlobal = function(a) { return "undefined" != typeof window && window === a ? a : "undefined" != typeof global ? global : a };
...
//     Basic = function(a) {
//         this.elem = a;
//         this.data = function() { return '{"tooltip":{"formatter":"{a} <br/>{b} : {c}%"},"series":[{"name":"\u4e1a\u52a1\u6307\u6807","type":"gauge","detail":{"formatter":"{value}%","width":"90","height":"60"},"center":["50%","70%"],"radius":"120%","startAngle":180,"endAngle":0,"data":[{"value":50,"name":"\u5b8c\u6210\u7387"}]}]}' };
...
//                 title: { text: "\u5168\u56fd\u9500\u91cf\u5206\u5e03", subtext: "data from xxx\u7cfb\u7edf", sublink: "http://www.163.com", left: "center", textStyle: { color: "#fff" } },
...
//                 series: [{ name: "xxx", type: "scatter", coordinateSystem: "geo", data: mapData, symbolSize: function(a) { return a[2] / 10 }, label: { normal: { formatter: "{b}", position: "right", show: !1 }, emphasis: { show: !0 } }, itemStyle: { normal: { color: "#ddb926" } } }, {
//                     name: "Top 10",
//                     type: "effectScatter",
//                     coordinateSystem: "geo",
//                     data: valueData,
//                     symbolSize: function(a) { return a[2] / 10 },
//                     showEffectOn: "render",
...
//             name: "\u957f\u6c99",
//             value: 175
//         }, { name: "\u8862\u5dde", value: 177 }, { name: "\u5eca\u574a", value: 193 }, { name: "\u83cf\u6cfd", value: 194 }, { name: "\u5408\u80a5", value: 229 }, { name: "\u6b66\u6c49", value: 273 }, { name: "\u5927\u5e86", value: 279 }
//     ],
//     geoCoordMap = {
//         "\u6d77\u95e8": [121.15, 31.89],
...
// (function(a, b) { "function" === typeof define && define.amd ? define(["exports", "echarts"], b) : "object" === typeof exports && "string" !== typeof exports.nodeName ? b(exports, require("echarts")) : b({}, a.echarts) })(this, function(a, b) {
//     var c = function(a) { "undefined" !== typeof console && console && console.error && console.error(a) };
...
Box.Application.addModule("topbarcollapse", function(a) {
    function b() { $(c).find("li a").removeClass("am-active") }
    var c;
    return {
        init: function() { c = a.getElement() },
        destroy: function() { c = null },
...
Box.Application.addModule("firstlevel", function(a) {
    ...
    return {
        ...
        onmessage: { firstOpen: function() { $(b).hasClass("am-hide") && $(b).removeClass("am-hide") }, firstClose: function() { $(b).hasClass("am-hide") || $(b).addClass("am-hide") } }
    }
});
...
Box.Application.addModule("secondlevel", function(a) {
    ...
    return {
        ...
        onmessage: { secondOpen: function() { $(b).hasClass("am-hide") && ($(b).removeClass("am-hide"), -1 == d && c.render(), d++) }, secondClose: function() { $(b).hasClass("am-hide") || $(b).addClass("am-hide") } }
    }
});